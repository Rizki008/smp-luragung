...
<div class="site-section">
	<div class="container">
		...
		echo form_open('pendaftaran/prestasi') ?>
		...
		<div class="row">
			...
			<div class="col-md-6 form-group">
				<label for="eaddress">Nomor USBN</label>
				<input type="text" id="eaddress" name="no_usbn" class="form-control form-control-lg">
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 form-group">
				<label for="tel">Asal Sekolah</label>
				<input type="text" id="tel" name="asal_sekolah" class="form-control form-control-lg">
			</div>
			<div class="col-md-6 form-group">
				<label for="tel">Tahun Lulus sekolah</label>
				<input type="date" id="tel" name="tahun_lulus" class="form-control form-control-lg">
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 form-group">
		...
		<div class="row">
			...
			<div class="col-md-6 form-group">
				<label for="message">Transportasi</label>
				<input type="text" id="tel" name="transport" class="form-control form-control-lg">
			</div>
		</div>
		<hr>
		...
		<div class="row">
			<div class="col-md-6 form-group">
				<label for="message">Bidang Prestasi Yang Sejenis</label>
				<input type="text" id="tel" name="prestasi" class="form-control form-control-lg">
			</div>
			<div class="col-md-6 form-group">
				<label for="message">Nama Kejuaraan/Lomba</label>
				<input type="text" id="tel" name="kejuaraan" class="form-control form-control-lg">
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 form-group">
				<label for="message">Tingkat</label>
				<input type="text" id="tel" name="tingkat" class="form-control form-control-lg">
			</div>
			<div class="col-md-6 form-group">
				<label for="message">Juara/Peringkat</label>
				<input type="text" id="tel" name="juara" class="form-control form-control-lg">
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 form-group">
				<label for="message">Penyelenggara</label>
				<input type="text" id="tel" name="penyelenggara" class="form-control form-control-lg">
			</div>
			<div class="col-md-6 form-group">
				<label for="message">Keterangan (beregu/Perorangan)</label>
				<input type="text" id="tel" name="keterangan" class="form-control form-control-lg">
			</div>
		</div>
