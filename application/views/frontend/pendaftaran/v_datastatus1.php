								...
								<tbody>
									...
									foreach ($status as $key => $value) { ?>
										<tr class="text-center">
											...
											<td><?= $value->rt ?>,<?= $value->rw ?>,<?= $value->lingkungan ?>,<br><?= $value->desa ?>,<?= $value->kecamatan ?>,<?= $value->kabupaten ?></td>
											<td><?= $value->jalur ?></td>
											<td><?php if ($value->status === '1') { ?>
												...
												<?php } elseif ($value->status === '0') { ?>
													<span class="badge badge-warning">Belum Ada Status</span>
												<?php } ?>
											</td>
											<td>
												<?php if ($value->status === '1') { ?>
													<a href="<?= base_url('cetak') ?>" class="btn btn-primary btn-sm">Cetak Hasil</a>
												<?php } elseif ($value->status === '2') { ?>
													<a href="<?= base_url('cetak') ?>" class="btn btn-primary btn-sm">Cetak Hasil</a>
												<?php } ?>
											</td>
